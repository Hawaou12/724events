...
const EventList = () => {
    ...
    const filteredEvents = ((!type ? data?.events : data?.events.filter((event) => event.type === type)) || []).filter((events, index) => {
        ...
        <>
            ...
            {data === null ? (
                ...
                <>
                    ...
                    <Select selection={Array.from(typeList)} onChange={(value) => (value ? onChange(value) : onChange(null))} />
